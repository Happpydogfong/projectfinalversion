...
public class fotoEditorGUI extends JFrame {
    ...
    public fotoEditorGUI() {
        ...
        grayscaleButton.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                filterApply.addFilter(new toGrayScale());
                render();
            }
        });
        ...
        brightnessButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    String input = JOptionPane.showInputDialog(fotoEditorGUI.this, "Enter brightness adjustment percentage:");
                    int percentage = Integer.parseInt(input);
                    filterApply.addFilter(new brithen(percentage));
                    render();
                } catch (NumberFormatException ex) {
                    ex.printStackTrace();
                    JOptionPane.showMessageDialog(fotoEditorGUI.this, "Invalid percentage input", "Error", JOptionPane.ERROR_MESSAGE);
                } catch (Exception ex) {
                    ex.printStackTrace();
        ...
        resizeButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    filterApply.addFilter(new Resize(newHeight));
                    render();
                } catch (NumberFormatException ex) {
                    ex.printStackTrace();
